...
export const Contact: NextPage<IContactProps> = ({ theme }) => {
  ...
  return (
    <>
     ...
     data-aos-anchor-placement="bottom-center" src={Gmail.src} alt="" /> jobforakash9770@gmail.com
      </div>
      {!loading ? (
        <form className="contact_form" autoComplete="off" ref={form}>
          ...
          <div className="contact_form_formcontrol">
            <button data-aos="zoom-out" className="contact_form_formcontrol_submit" onClick={handleSubmit}>
              Submit
            </button>
          </div>
        </form>
